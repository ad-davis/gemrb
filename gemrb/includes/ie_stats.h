...
// NOTE: we use IF_VISIBLE instead, so it could be removed if any conflict with disease arises
...
#define _DEAD_STATES     (STATE_EXPLODING|STATE_FLAME|STATE_ACID|STATE_DEAD|STATE_PETRIFIED|STATE_FROZEN) //0x0fc0: just a shorthand
...
#define STATE_NOSAVE     _DEAD_STATES //don't save these, 0x00000fc0
